...
|------|------|------|------|------|------|------|------|------|
| F-SPEC/ARCH/DM/PROC-20260611 ×28 | audit | 2026-06-11 | spec/arch/dm/proc | 第二轮全量审查 28 发现（HIGH 2 / MEDIUM 13 / LOW 13）：**HIGH=README 与 data-model 双停更**；三大家族复发——取代漏标 ×11（spec 8+dm 3）、文档停更 ×5（architecture/data-model/README/CLAUDE.md/modules 自检段）、ADR 缺口 ×1；CI Node20 弃用硬时限 5 天（999d）——详见 findings-registry 与 docs/audit/2026-06-11-*.md | 偏差/缺失/风险 | 项目级 | resolved（27/28：R14-fix 直修+PR #24+ADR×2+PP×2；5d32 deferred） | R14 第二轮审查 / HIGH handoff 2026-06-11-audit-high-findings.md |
| F-SPEC-20260605-5c55~98ef / F-ARCH-4c50 / F-DM-6bc0 / F-PROC-6fd2,50a9,e0e8 | audit | 2026-06-05 | spec/arch/dm/proc | 首轮全量审查 8 发现（5 MEDIUM / 3 LOW）：取代标注家族×7、两文档停更、CLAUDE.md 过时、直推与分支保护冲突、Code Map 缺——详见 findings-registry 与 docs/audit/2026-06-05-*.md | 偏差/风险/缺失 | 项目级 | resolved（R6-C 直修+50a9 决议，状态回写于 2026-06-12——R6 收尾漏流转，R14 补） | R6-B 首轮审查 |
